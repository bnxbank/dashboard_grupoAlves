...
@app.route('/faturamento', defaults={'secao': 'GERAL', 'ano': datetime.now().year, 'loja': 'GERAL'}, methods=['GET'])
@app.route('/faturamento/<secao>/<loja>/<ano>', methods=['GET'])
def faturamento(secao, ano, loja):
    if ano is None:
