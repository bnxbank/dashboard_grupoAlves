...
google.charts.setOnLoadCallback(function () {
    drawCharts(allData, "2023"); // Dados de 2023
...
function drawCharts(dataSet, idSuffix) {
    ...
    var container = document.getElementById("charts" + idSuffix);

    for (var i = 1; i <= columnTitles.length; i++) {
        drawIndividualChart(i, columnTitles[i - 1], idSuffix, container);
    }
}
...
function drawIndividualChart(
    ...
    var chartColors = [
        /* Cores do gráfico */
        '#0048ff', '#f6af00', '#19770c', '#050949',
        '#e53d00', '#00FFFF', '#008062', '#ffed00',
        '#ef37cd',
    ];
